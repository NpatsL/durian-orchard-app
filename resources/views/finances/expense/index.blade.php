<x-app-layout>
    <div class="max-w-5xl mx-auto mt-10 p-4 shadow-md rounded-lg border-t-2 border-teal-400">
        <div class="flex justify-between">
            ...
            <a href="{{ route('finances.expense.create') }}"
                class="bg-blue-400 hover:bg-blue-600 text-black font-bold py-2 px-4 rounded">New Expense</a>
        </div>
                                    ...
                                    @if (count($expenses) === 0)
                                        <div
                                            ...
                                            <h2 class="mt-5 font-semibold text-gray-800 ">
                                                There are no expense records in the system.
                                            </h2>
                                                        ...
                                                        <td class="h-px w-px whitespace-nowrap">
                                                            <a class="block relative z-10" href="#">
                                                                <div class="px-6 py-2">
                                                                    <p class="text-sm">
                                                                    @if ( $expense->material )
                                                                        {{$expense->material->lotMaterial->date}}
                                                                    @endif
                                                        ...
                                                        <td class="h-px w-px whitespace-nowrap">
                                                            <div class="px-6 py-2">
                                                                <div class="flex justify-end">
                                                                    <a href="{{ route('finances.expense.edit', $expense->id) }}"
                                                            ...
                                                            <form
                                                                action="{{ route('finances.expense.destroy', $expense->id) }}"
                                                                ...
                                                                <button
                                                                    ...
                                                                    onclick="return confirm('Are you sure you want to delete this expense record?')">Delete</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </td>
